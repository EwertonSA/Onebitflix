...
exports.WatchTime = exports.Like = exports.Favorite = exports.User = exports.Episode = exports.Course = exports.Category = void 0;
...
Object.defineProperty(exports, "WatchTime", { enumerable: true, get: function () { return WatchTimes_1.WatchTime; } });
...
Course_1.Course.hasMany(Favorite_1.Favorite, { as: 'favoriteUsers', foreignKey: 'course_id' });
Episode_1.Episode.belongsTo(Course_1.Course);
Episode_1.Episode.belongsToMany(User_1.User, { through: WatchTimes_1.WatchTime });
...
User_1.User.belongsToMany(Episode_1.Episode, { through: WatchTimes_1.WatchTime });
